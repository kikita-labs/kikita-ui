...
function createLightSemanticVariables(
  ...
  return {
    '--kui-color-bg': 'var(--kui-neutral-1)',
    '--kui-color-surface': 'oklch(1 0 0)',
    '--kui-color-surface-elevated': 'oklch(0.99 0.005 80)',
    '--kui-color-surface-sunken': 'var(--kui-neutral-2)',
    '--kui-color-border': 'var(--kui-neutral-3)',
    '--kui-color-border-strong': 'var(--kui-neutral-4)',
    '--kui-color-text': 'var(--kui-neutral-9)',
    '--kui-color-text-secondary': 'var(--kui-neutral-7)',
    '--kui-color-text-disabled': 'var(--kui-neutral-5)',
...
function createDarkSemanticVariables(
  ...
  return {
    '--kui-color-bg': 'var(--kui-neutral-12)',
    '--kui-color-surface': 'var(--kui-neutral-11)',
    '--kui-color-surface-elevated': 'var(--kui-neutral-10)',
    '--kui-color-surface-sunken': 'var(--kui-neutral-12)',
    '--kui-color-border': 'var(--kui-neutral-9)',
    '--kui-color-border-strong': 'var(--kui-neutral-8)',
    '--kui-color-text': 'var(--kui-neutral-2)',
    '--kui-color-text-secondary': 'var(--kui-neutral-5)',
    '--kui-color-text-disabled': 'var(--kui-neutral-7)',
...
function createComponentVariables(options: KuiThemeOptions): KuiCssVariableMap {
  ...
  return {
    ...
    '--kui-badge-success-bg': 'var(--kui-success-1)',
    '--kui-badge-success-fg': 'var(--kui-success-7)',
    '--kui-badge-success-border': 'var(--kui-color-success-fill)',
    '--kui-badge-warning-bg': 'var(--kui-warning-1)',
    '--kui-badge-warning-fg': 'var(--kui-warning-7)',
    '--kui-badge-warning-border': 'var(--kui-color-warning-fill)',
    '--kui-badge-danger-bg': 'var(--kui-danger-1)',
    '--kui-badge-danger-fg': 'var(--kui-danger-7)',
    '--kui-badge-danger-border': 'var(--kui-color-danger-fill)',
    '--kui-badge-info-bg': 'var(--kui-info-1)',
    '--kui-badge-info-fg': 'var(--kui-info-7)',
    '--kui-badge-info-border': 'var(--kui-color-info-fill)',
